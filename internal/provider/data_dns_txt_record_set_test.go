...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestMatchResourceAttr(recordName, "record", regexp.MustCompile("^(_globalsign-domain-verification|google-site-verification|keybase-site-verification)=")),
					resource.TestCheckResourceAttr(recordName, "records.#", "6"),
