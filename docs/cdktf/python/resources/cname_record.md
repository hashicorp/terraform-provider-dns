...
#
from imports.dns.cname_record import CnameRecord
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        CnameRecord(self, "foo",
...
<!-- cache-key: cdktf-0.20.0 input-94fad5b5fba9781dec461d2e21acefc4daf14ee6fd3cb2ed6a6e1187bf94dc26 -->